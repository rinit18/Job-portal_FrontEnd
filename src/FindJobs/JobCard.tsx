...
const JobCard = (props:any) => {
    return( 
    <div className="bg-mine-shaft-900 p-4 w-72 flex flex-col gap-3 rounded-xl shadow-lg hover:cursor-pointer hover:shadow-2xl transform hover:-translate-y-2 transition-transform duration-300 ease-in-out">
