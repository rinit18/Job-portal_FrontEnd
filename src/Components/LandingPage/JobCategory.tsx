...
import { 
    IconArrowLeft, IconArrowRight, IconSpeakerphone, IconCode, 
    IconPalette, IconBrush, IconPencil, IconKeyboard, 
    IconHeadset, IconTrendingUp, IconCoin, IconUsers, IconBriefcase 
} from "@tabler/icons-react";

// Map category names to Tabler Icons
const categoryIcons: Record<string, any> = {
    "Digital Marketing": IconSpeakerphone,
    "Web Developer": IconCode,
    "Arts & Design": IconPalette,
    "UI-UX Designer": IconBrush,
    "Content Writing": IconPencil,
    "Data Entry": IconKeyboard,
    "Customer Support": IconHeadset,
    "Sales": IconTrendingUp,
    "Finance": IconCoin,
    "Human Resource": IconUsers,
};
    ...
    return <section className="mt-24 pb-10 overflow-hidden relative">
        ...
        >
            {jobCategory.map((category, index) => {
                const IconComponent = categoryIcons[category.name] || IconBriefcase;
                ...
                return (
                    <Carousel.Slide key={index} className="py-4">
                        ...
                        >
                            <div className="p-4 bg-gradient-to-br from-bright-sun-400/20 to-bright-sun-400/5 rounded-2xl group-hover:scale-110 group-hover:from-bright-sun-400/30 transition-all duration-500 text-bright-sun-400">
                                <IconComponent size={40} stroke={1.5} className="drop-shadow-[0_0_10px_rgba(250,204,21,0.3)]" />
                            </div>
