import { IconBrandFacebook, IconBrandInstagram, IconBrandLinkedin, IconBriefcase2 } from "@tabler/icons-react";
...
return (
    ...
    <div className="mt-20 pt-20 pb-5 flex gap-5 justify-around bg-mine-shaft-950 font-['poppins']">
        ...
        </div>
        {
            ...
            footerLinks.map((item, index) => <div key={index}>
                        ...
                        {
                                item.links.map((link, index) => <div key={index} className="text-mine-shaft-300 text-sm hover:text-bright-sun-300 cursor-pointer mb-1 
